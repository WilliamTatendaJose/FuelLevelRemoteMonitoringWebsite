...
namespace DeanRemoteMonitoringWeb.Client.Pages
{
    public partial class ApplicationRoles
    {
        ...
        protected RadzenDataGrid<DeanRemoteMonitoringWeb.Server.Models.ApplicationRole> grid0;
        ...
        protected async Task DeleteClick(DeanRemoteMonitoringWeb.Server.Models.ApplicationRole role)
        {
            try
            {
