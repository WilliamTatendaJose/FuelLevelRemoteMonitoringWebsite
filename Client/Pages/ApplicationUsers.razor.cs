...
namespace DeanRemoteMonitoringWeb.Client.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<DeanRemoteMonitoringWeb.Server.Models.ApplicationUser> users;
        protected RadzenDataGrid<DeanRemoteMonitoringWeb.Server.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(DeanRemoteMonitoringWeb.Server.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(DeanRemoteMonitoringWeb.Server.Models.ApplicationUser user)
        {
            try
            {
